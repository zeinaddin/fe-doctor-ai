...
export const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { title: t('nav.symptomChecker'), icon: Activity, href: '/admin/symptom-checker' },
  ];
  ...
  return (
    <div className="min-h-screen bg-background theme-admin">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-violet-50/50 via-transparent to-purple-50/30 pointer-events-none" />
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-3 border-b border-gray-200/60">
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-md bg-violet-50 text-violet-700 text-xs font-medium">
              ...
              return (
                <Button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-violet-50 text-violet-700 hover:bg-violet-100 font-medium"
